                    ...
                    <div class="card card-body">
                        <form method="post" name="form" onsubmit="return validarform()" action="create.php">
                            <div class="form-group">
                                <input type="text" name="username" class="form-control" placeholder="Ingresa username"
                                    autocomplete="off" required>
                            </div>
                            <div class="form-group">
                                <input type="text" name="password" class="form-control" placeholder="Ingresa contraseña"
                                    autocomplete="off" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <input type="text" name="budget" class="form-control" placeholder="Ingresa budget"
                                    autocomplete="off" required>
                            </div>
